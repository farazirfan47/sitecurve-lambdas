  ...
  try {
    ...
    for (let chunk of chunks) {
      ...
      for (let serpJob of chunk) {
        ...
        task.pingback_url =
          "https://2vqsvcldyg.execute-api.us-east-2.amazonaws.com/default/content-parse-postback?id=$id&tag=$tag&page_id=" +
          serpJob.serp_id;
        tasks.push(task);
      }
      ...
      //})
      //);
      // Add a delay of 1 second before sending the next batch of tasks
